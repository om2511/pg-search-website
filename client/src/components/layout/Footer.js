...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    },
    {
      ...
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.62 5.367 11.987 11.988 11.987s11.987-5.367 11.987-11.987C24.014 5.367 18.637.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.49-3.323-1.297C4.198 14.895 3.73 13.88 3.73 12.582s.468-2.313 1.396-3.109c.875-.807 2.026-1.297 3.323-1.297s2.448.49 3.323 1.297c.928.796 1.396 1.811 1.396 3.109s-.468 2.313-1.396 3.109c-.875.807-2.026 1.297-3.323 1.297zm7.718-1.297c-.875.807-2.026 1.297-3.323 1.297s-2.448-.49-3.323-1.297c-.928-.796-1.396-1.811-1.396-3.109s.468-2.313 1.396-3.109c.875-.807 2.026-1.297 3.323-1.297s2.448.49 3.323 1.297c.928.796 1.396 1.811 1.396 3.109s-.468 2.313-1.396 3.109z"/>
        </svg>
      )
    },
    {
      ...
      <div className="relative border-b border-gray-800 dark:border-dark-700">
        <div className="container-responsive py-16">
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold mb-4">Why Choose FindMyPG?</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => {
              ...
              return (
                ...
                >
                  <div className="w-16 h-16 bg-gradient-to-r from-primary-600 to-secondary-600 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300 shadow-lg">
      ...
      <div className="relative">
        <div className="container-responsive py-16">
          <div className="grid grid-cols-1 lg:grid-cols-6 gap-8">
            ...
            <div className="lg:col-span-2">
              <Link to="/" className="flex items-center space-x-3 mb-6 group">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">Premium Living Spaces</p>
                </div>
              </Link>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-3 text-gray-400 hover:text-white transition-colors">
                  ...
                  <span>hello@findmypg.com</span>
                </div>
                <div className="flex items-center space-x-3 text-gray-400 hover:text-white transition-colors">
                  <GlobeAltIcon className="w-5 h-5 text-primary-500" />
                  <span>www.findmypg.com</span>
                </div>
              </div>
              ...
              <div className="flex space-x-4 mt-6">
                {socialLinks.map((social, index) => (
                  <a
                    key={index}
                    href={social.href}
                    className="w-12 h-12 bg-gray-800 dark:bg-dark-800 rounded-xl flex items-center justify-center text-gray-400 hover:text-white hover:bg-gradient-to-r hover:from-primary-600 hover:to-secondary-600 transition-all duration-300 transform hover:scale-110 shadow-lg hover:shadow-glow"
            ...
            <div>
              <h3 className="text-lg font-semibold mb-6 text-white">For Owners</h3>
              <ul className="space-y-3">
          ...
          {/* Newsletter Signup */}
          <div className="mt-16 pt-12 border-t border-gray-800 dark:border-dark-700">
            <div className="max-w-2xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row max-w-md mx-auto space-y-3 sm:space-y-0 sm:space-x-3">
                <input
                  ...
                  className="flex-1 px-4 py-3 bg-gray-800 dark:bg-dark-800 border border-gray-700 dark:border-dark-600 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500 transition-all duration-300"
                />
        ...
        <div className="container-responsive py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="flex items-center space-x-4 text-gray-400 text-sm">
              <span>© 2024 FindMyPG. All rights reserved.</span>
            ...
            <div className="flex items-center space-x-6">
              ...
              <button
                onClick={scrollToTop}
                className="p-3 bg-gray-800 dark:bg-dark-800 rounded-xl hover:bg-gradient-to-r hover:from-primary-600 hover:to-secondary-600 transition-all duration-300 transform hover:scale-110 shadow-lg hover:shadow-glow"
